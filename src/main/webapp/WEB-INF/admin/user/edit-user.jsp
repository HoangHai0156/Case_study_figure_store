        ...
        <form method="post">
          <fieldset>
            ...
            <table class="table table-striped table-hover">
              ...
              <tr>
                <td>Address </td>
                <td><input type="text" name="address" id="address" class="form-control" value="${user.address}"></td>
              </tr>
              <tr>
                <td>Phone </td>
                <td><input type="text" name="phone" id="phone" class="form-control" value="${user.phone}"></td>
              </tr>
              <tr>
                <td>Email </td>
              ...
              <tr>
                <td>Password </td>
                <td><input type="text" name="password" id="password" class="form-control" value="${user.password}"></td>
              </tr>
              <tr>
                <td>Role: </td>
                <td>
